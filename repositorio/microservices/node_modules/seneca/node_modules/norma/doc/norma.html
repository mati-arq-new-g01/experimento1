...
<span class="hljs-keyword">var</span> error = <span class="hljs-built_in">require</span>(<span class="hljs-string">'eraro'</span>)({package:<span class="hljs-string">'norma'</span>})</pre></div></div>
  ...
  onfail:<span class="hljs-string">'throw'</span>,
  desclen:<span class="hljs-number">33</span>
}</pre></div></div>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse_spec</span><span class="hljs-params">( spec )</span> </span>{
  ...
  <span class="hljs-keyword">catch</span>(e) {
    <span class="hljs-keyword">throw</span> error(<span class="hljs-string">'parse'</span>, e.message+<span class="hljs-string">'; spec:"'</span>+spec+
                <span class="hljs-string">'", col:'</span>+e.column+<span class="hljs-string">', line:'</span>+e.line)
  }
}</pre></div></div>
  ...
  <span class="hljs-keyword">if</span>( !outslots ) {
    <span class="hljs-keyword">if</span>( <span class="hljs-string">'throw'</span> == options.onfail ) {
      <span class="hljs-keyword">throw</span> error(
        ...
        <span class="hljs-string">'invalid arguments; expected: "'</span>+specdef.spec+
          <span class="hljs-string">'", was: ['</span>+argdesc+<span class="hljs-string">']; values: '</span>+descargs(args,options),
...
<p>Example: [“a”,1] =&gt; “si”.</p>
  ...
  args.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(arg)</span></span>{
    ...
    <span class="hljs-keyword">if</span>( _.isString(arg) ) {
    ...
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isNumber(arg) ) {
      desc.push(<span class="hljs-string">'n'</span>)
    }
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isBoolean(arg) ) {
      desc.push(<span class="hljs-string">'b'</span>)
    }
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isFunction(arg) ) {
      desc.push(<span class="hljs-string">'f'</span>)
    }
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isArray(arg) ) {
      desc.push(<span class="hljs-string">'a'</span>)
    }
    ...
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isNull(arg) ) {
      desc.push(<span class="hljs-string">'N'</span>)
    }
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isUndefined(arg) ) {
      desc.push(<span class="hljs-string">'U'</span>)
    }
    <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>( _.isObject(arg) ) {
...
<p>Avoids over long messages.</p>
  ...
  _.each(args,<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(arg)</span></span>{
...
<p>Options are … optional.</p>
  ...
  <span class="hljs-keyword">if</span>( _.isArguments(options) || _.isArray(options ) ) {
    rawargs = options
    options = <span class="hljs-literal">null</span>
  }
  options = <span class="hljs-literal">null</span> == options ? defopts : _.extend({},defopts,options)
  ...
  <span class="hljs-keyword">if</span>( <span class="hljs-literal">null</span> == rawargs ) {
    <span class="hljs-keyword">throw</span> error(
      ...
      {<span class="hljs-built_in">arguments</span>:<span class="hljs-built_in">arguments</span>}
    )
  }
...
<p><em>toString</em> shows you the constructed regexp (for debugging).</p>
  ...
  out.toString = <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
    <span class="hljs-keyword">return</span> util.inspect({spec:specdef.spec, re:<span class="hljs-string">''</span>+specdef.re})
  }
  <span class="hljs-keyword">return</span> out
}</pre></div></div>
